  ...
  return (
    <div className="flex h-full min-h-screen items-center justify-center rounded-[32px] border border-[#ECECEC] bg-white">
      <div className="flex flex-col items-center">
        ...
        <p className="mt-5 max-w-[700px] text-center text-[18px] leading-[34px] text-[#7B7B7B]">
          The assignment archive is still busy organizing generations of teacher
          PDFs and last-minute submissions 📂
        </p>
      </div>
    </div>
  );
